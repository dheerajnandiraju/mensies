...
export default function LastMonthPeriod() {
  ...
  const handleNext = () => {
    ...
    router.push('/MonthBeforeLastPeriod');
  };
    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={{ flex: 1, backgroundColor: '#C2DED1', padding: wp('5%') }}>
        ...
        <Text style={{ fontSize: wp('5%'), marginBottom: hp('1.5%') }}>
          When did your period start last month?
        </Text>
        ...
        >
          How many days did your period last last month?
        </Text>
